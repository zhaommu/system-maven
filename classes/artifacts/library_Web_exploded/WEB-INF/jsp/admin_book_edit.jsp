        ...
        <div class="panel-body">
            <form action="book_edit_do.html?bookId=${detail.bookId}" method="post" id="addbook" >
                ...
                <div class="input-group">
                    <span  class="input-group-addon">商标名</span>
                ...
                <div class="input-group">
                    <span class="input-group-addon">商标号</span>
                    <input type="text" class="form-control" name="商标号" id="商标号"  value="${detail.ISBN}" >
                </div>
                <div class="input-group">
                ...
                <script>
                    $("#addbook").submit(function () {
                        if($("#name").val()==''||$("#author").val()==''||$("#publish").val()==''||$("#商标号").val()==''||$("#introduction").val()==''||$("#language").val()==''||$("#price").val()==''||$("#pubstr").val()==''||$("#classId").val()==''||$("#number").val()==''){
                            alert("请填入完整商标信息！");
                            return false;
                        }
                    })
